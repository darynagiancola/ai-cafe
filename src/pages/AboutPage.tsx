  ...
  return (
    <section className="container-shell py-10 sm:py-14">
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-3">
        <article className="card-surface bg-[#fffaf4] p-6">
          <Bean className="h-6 w-6 text-[#8b4f38]" />
          <h2 className="display-serif mt-4 text-3xl font-semibold text-[#2a2320]">Coffee philosophy</h2>
        ...
        <article className="card-surface bg-[#fffaf4] p-6">
          ...
          <h2 className="display-serif mt-4 text-3xl font-semibold text-[#2a2320]">Sourcing & ingredients</h2>
          <p className="mt-2 text-sm leading-relaxed text-[#695f58]">
        ...
        <article className="card-surface bg-[#fffaf4] p-6">
          ...
          <h2 className="display-serif mt-4 text-3xl font-semibold text-[#2a2320]">Atmosphere</h2>
          <p className="mt-2 text-sm leading-relaxed text-[#695f58]">
